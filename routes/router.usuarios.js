...
//---------------------------------------USUARIOS------------------------------------------------
router_usuarios.post('/createUser', controller_auth.verify_token, controller_usuarios.createUser, controller_auth.checkAdmin)
router_usuarios.get(
	'/edit-usuario-actual',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.view_edit_current_user,
	controller_auth.checkAdmin
)
router_usuarios.post(
	'/edit-usuario-actual/:id',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.update_current_user,
	controller_auth.checkAdmin
)
router_usuarios.get(
	'/ajustes/conf_usuarios',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.getUsers,
	controller_auth.checkAdmin
)
router_usuarios.get(
	'/ajustes/new_usuario',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.newUser,
	controller_auth.checkAdmin
)
router_usuarios.get(
	'/ajustes/edit-usuario/:id',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.getUser,
	controller_auth.checkAdmin
)
router_usuarios.post(
	'/ajustes/edit-usuario/:id',
	controller_auth.verify_token,
	controller_auth.isAuthenticated,
	controller_usuarios.updateUser,
	controller_auth.checkAdmin
)
router_usuarios.get(
