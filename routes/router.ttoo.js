...
router_ttoo.get('/ajustes/ttoo-conf/:id', authController.isAuthenticated, ttooController.getTtoo)
router_ttoo.post('/ajustes/ttoo-conf/:id', authController.isAuthenticated, ttooController.updateTtoo)
